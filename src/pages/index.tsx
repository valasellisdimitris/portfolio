...
export default function HomePage() {
  ...
  const description = "Experienced Next.js front-end developer specializing in building pixel-perfect, high-performance web applications. Expert in React, TypeScript, and modern web technologies.";
  ...
  return (
    <div className="w-full min-h-screen flex flex-col p-0 m-0 overflow-x-hidden bg-white max-w-full">
      <Head>
        ...
        <meta name="keywords" content="Dimitris Valasellis, Next.js developer, React developer, front-end developer, web development, TypeScript, Tailwind CSS, JavaScript, Greece developer" />
        ...
        {/* Additional SEO */}
        <meta name="google-site-verification" content="dO27Tt2UF8MQLuCdy1Sra1wyhKrweekwn4DOmvLITkc" />
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              sameAs: [
                "https://github.com/valasellisdimitris",
              ],
              knowsAbout: [
                "Next.js",
                "React",
      ...
      <Header />
      <main id="main-content" className="w-full h-full flex flex-col mt-[175px] gap-16">
